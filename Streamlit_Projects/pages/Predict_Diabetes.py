...
glucose = st.slider("Glucose", min_value = diabetes_df['Glucose'].min(), max_value = diabetes_df['Glucose'].max())
bp = st.slider("BP", min_value = diabetes_df['Blood_Pressure'].min(), max_value = diabetes_df['Blood_Pressure'].max())
insulin = st.slider("Insulin", min_value = diabetes_df['Insulin'].min(), max_value = diabetes_df['Insulin'].max())
bmi = st.slider("BMI", min_value = diabetes_df['BMI'].min(), max_value = diabetes_df['BMI'].max())
pedigree = st.slider("Pedigree Function", min_value = diabetes_df['Pedigree_Function'].min(), max_value = diabetes_df['Pedigree_Function'].max())
age = st.slider("Age", min_value = diabetes_df['Age'].min(), max_value = diabetes_df['Age'].max())
